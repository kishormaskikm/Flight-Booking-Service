...
const { BOOKED, CANCELLED , CONFIRMED} = Enum.BOOKING_STATUS;
...
async function makePayment(data) {
    ...
    try {
        ...
        // we assume here that payment is successful
         ...
         Queue.sendData({
            recepientEmail: 'developer.kishor0@gmail.com',
...
async function cancelBooking(bookingId) {
    ...
    try {
        ...
        await bookingRepository.update(bookingId, {status: CONFIRMED}, transaction);
        await transaction.commit();
